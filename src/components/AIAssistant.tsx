...
export function AIAssistant({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', text: 'Olá! Sou seu assistente de produtividade. Posso analisar suas tarefas, sugerir prioridades, organizar seu dia e muito mais. Como posso ajudar?' },
  ]);
